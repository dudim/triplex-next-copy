...
describe("MediaMaxWidth", () => {
    ...
    describe("initial render", () => {
        it("should render children when window width is below maxWidth", () => {
            window.innerWidth = 500; // Below MD_MAX (991px)
            ...
            render(
                <MediaMaxWidth maxWidth={EScreenWidth.MD_MAX} fallback={mockFallback}>
                    {mockChildren}
                </MediaMaxWidth>,
            );
        ...
        it("should render children when window width is significantly below maxWidth", () => {
            window.innerWidth = 400; // Well below MD_MAX (991px)
    ...
    describe("media query setup", () => {
        it("should create correct media query string for max-width", () => {
            mockMatchMedia.mockReturnValue({
                matches: true,
                addEventListener: mockAddEventListener,
                removeEventListener: mockRemoveEventListener,
    ...
    describe("media query change handling", () => {
        it("should update state when media query matches changes to true", () => {
            // Set initial window width to be above the maxWidth
            window.innerWidth = 1000; // Above MD_MAX (991px)
        ...
        it("should update state when media query matches changes to false", () => {
            // Set initial window width to be below the maxWidth
            window.innerWidth = 500; // Below MD_MAX (991px)
